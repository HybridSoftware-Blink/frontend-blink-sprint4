    ...
    <form class="space-y-6" @submit.prevent="handleLogin" novalidate>
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center">
          ...
          <label for="remember-me" class="ml-2 block text-sm text-gray-700 cursor-pointer select-none">Remember me</label>
        </div>
        <div class="text-sm">
          <a href="#" style="color: #89C242;" class="hover:brightness-75 transition-all">Forgot password?</a>
        </div>
      </div>
